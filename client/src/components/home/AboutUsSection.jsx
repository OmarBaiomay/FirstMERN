  ...
  return (
    <section className='section' id='about'>
        <div className='container'>
            <div className='bg-zinc-800 dark:bg-zinc-800/50 p-7 rounded-2xl md:p-12 '>
            <h2 className='text-zinc-300 font-bold mb-4 md:text-3xl'>About Us</h2>
                <p className='text-zinc-300 mb-4 md:mb-8 md:text-md'>
                        ...
                        aboutItems.map(({label, number}, key) =>(
                            <div className='' key={key}>
                                <div className='flex items-center md:mb-2'>
                                    <span className='text-2xl text-zinc-50 dark:text-zinc-300 font-bold md:text-4xl'>{number}</span>
                                    <span className='text-2xl text-purple-600 font-semibold'> +</span>
                                </div>
                                <p className='text-sm text-zinc-200 dark:text-zinc-100'>{label}</p>
                            </div>
                        ))
                    }
                    <div className=''>
                        <div className='flex items-center md:mb-2'>
                            <span className='text-2xl text-zinc-50 dark:text-zinc-300 font-bold md:text-4xl'>8</span>
                            <span className='text-2xl text-purple-600 font-semibold'></span>
                        </div>
                        <p className='text-sm text-zinc-200 dark:text-zinc-100'>USD Only Per Hour</p>
                    </div>
